...
\newcommand{\PCGridContour}{ %Contour grille
	...
	\draw[blue, very thick] (0,0) rectangle (8,6);
}
...
\newcommand{\PCGridLegend}{
	\fill[black] (9-0.03,4.5-0.03) rectangle ++(1+0.06,1+0.06);
	\draw[very thin,gray,dotted] (9,4.5) rectangle ++(1,1);
	\draw (9.5,4.5+1) node[above] {Case vide};
	
	\fill[black] (9-0.03,3.1-0.03) rectangle ++(1+0.06,1+0.06);
	\draw[very thin,gray,dotted] (9,3.1) rectangle ++(1,1);
	\draw (9.5,3.1+1) node[above] {Mur};
	\PCGridWall{9}{5+3.1}
		
	\fill[black] (9-0.03,1.7-0.03) rectangle ++(1+0.06,1+0.06);
	\draw[very thin,gray,dotted] (9,1.7) rectangle ++(1,1);
	\draw (9.5,1.7+1) node[above] {Pac-Man};
	\PCPacMan{9}{5+1.7}{0}
	
	\fill[black] (9-0.03,0.3-0.03) rectangle ++(1+0.06,1+0.06);
	\draw[very thin,gray,dotted] (9,0.3) rectangle ++(1,1);
	\draw (9.5,0.3+1) node[above] {Fruits};
	\PCFruit{9}{5+0.3}{red}
}
